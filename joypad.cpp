...
///**
// * @brief JoyPad::setXY
// * @param value of xy axes from -1 to 1
// */
//void JoyPad::setXY(float xValue, float yValue)
//{
//    m_x = constrain(xValue, -1.f, 1.f);
//    m_y = constrain(yValue, -1.f, 1.f);
